#-----------------------------------------------------------------------------#
#                 Simple-model daily validation - BE                        #
#-----------------------------------------------------------------------------#
# Description:
# This script performs short-term daily validation for the BE analysis. It
# creates participant-week test sets, trains the DEML base and meta-models, and
# saves temperature and humidity validation results.
#
# Outputs:
# - results/Model/Temporal_Validation_daily_BE/Temperature/*
# - results/Model/Temporal_Validation_daily_BE/Humidity/*
#-----------------------------------------------------------------------------#
...
path_out <- file.path(project_root, "results", "Model", "Temporal_Validation_daily_BE", "")
