#-----------------------------------------------------------------------------#
#                    Long-term temporal validation - DEML weekly               #
#-----------------------------------------------------------------------------#
# Description:
# This script trains and evaluates the DEML ensemble model for long-term weekly
# indoor temperature and humidity prediction. It builds RF, XGBoost, GBM, and
# meta-model components, combines them with NNLS weights, and saves the final
# validation outputs for downstream analysis and plotting.
#
# Outputs:
# - results/Model/Temporal_Validation_weekly_40/Temperature/*.csv
# - results/Model/Temporal_Validation_weekly_40/Humidity/*.csv
# - results/Model/Temporal_Validation_weekly_40/Temperature/*.rds
# - results/Model/Temporal_Validation_weekly_40/Humidity/*.rds
#-----------------------------------------------------------------------------#
...
path_out <- file.path(project_root, "results", "Model", "Temporal_Validation_weekly_40")
